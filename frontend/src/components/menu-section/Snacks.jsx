            ...
            <div className="food-items">
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Crispy potato patties topped with tangy yogurt & sweet-spicy chutneys - a street food marvel that dances on your taste buds!</p>
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Fluffy, deep-fried bhature with spicy chickpea curry - a Punjabi classic that's a flavor explosion in every bite!</p>
                        <button className="add-to-cart"
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Soft, butter-brushed kulche with masaledar chhole cooked in our secret spice blend - a North Indian delight you'll crave daily!</p>
                        <button className="add-to-cart"
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Soft lentil dumplings in creamy yogurt with sweet-tangy chutneys - a refreshing chaat that cools your soul!</p>
                        <button className="add-to-cart"
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Crispy, golden-brown rice crepe with sambar and coconut chutney - South India's gift that makes every bite memorable!</p>
                        <button className="add-to-cart"
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Hollow, crispy puris with spicy jaljeera water - pop whole for a flavor explosion that'll make you say 'Ek aur!'</p>
                        <button className="add-to-cart"
                ...
                <div className="food-card">
                    ...
                    <div className="food-info">
                        ...
                        <p className="food-description">Buttery pav with mashed veggies in rich, spicy gravy - Mumbai's favorite street food that comforts your soul!</p>
                        <button className="add-to-cart"
